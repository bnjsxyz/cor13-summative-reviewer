...
- Start and finish timestamps displayed on both certificate formats
- Manual-entry essay fields that reject pasted or drag-and-dropped text
- A certificate button that returns learners to the Lesson Concept Review
